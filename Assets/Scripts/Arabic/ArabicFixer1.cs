...
public class ArabicFixer : MonoBehaviour
{
    ...
    public void Update()
    {
        ...
        fixedText = FixTextForUI(fixedText);
    ...
    public string FixTextForUI(string inputText)
    {
        if (!string.IsNullOrEmpty(inputText))
        {
            string rtlText = ArabicSupport.Fix(inputText, ShowTashkeel, UseHinduNumbers);
        ...
        return "";  // أضفت هذا للتأكد من إرجاع قيمة في جميع الحالات
    }
